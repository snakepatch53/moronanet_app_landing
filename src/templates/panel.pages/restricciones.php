        ...
        <div class=" pt-4 px-md-5 px-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Restricciones</li>
                </ol>
            </nav>
                    ...
                    <table class="table table-striped table-hover border">
                        <thead class="bg-dark text-light">
                            <tr>
                                ...
                                <th class="text-center text-md-left" scope="col">Descripcion</th>
        ...
        <div class="modal fade" id="element-modalform" tabindex="-1" aria-labelledby="element-modalformLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form class="modal-content needs-validation" id="element-form" onsubmit="return false" novalidate>
                    <input type="hidden" name="restriccion_id" value="0">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <label for="validationServer01" class="form-label">Descripcion</label>
                                <textarea class="form-control" name="restriccion_desc" id="validationServer01" placeholder="Descripcion.." rows="10" required></textarea>
                                <div class="invalid-feedback">
                                    Describe la restriccion!
                                </div>
                            </div>
...
<foot>
    ...
    <script src="<?= $DATA['http_domain'] ?>public/js.panel/restricciones.js"></script>
</foot>
