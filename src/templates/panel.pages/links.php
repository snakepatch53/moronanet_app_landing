                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="validationServer01" placeholder="Nombre.." name="link_name" required>
                                <div class="invalid-feedback">
                                    Escribe el nombre del enlace!
                                </div>
                            </div>

                            <div class="col-md-12">
                                <label for="validationServer02" class="form-label">Url</label>
                                <input type="text" class="form-control" id="validationServer02" placeholder="Url.." name="link_ref" required>
                                <div class="invalid-feedback">
                                    Ingrese el URL!
                                </div>
                            </div>
...
<foot>
    ...
    <script src="<?= $DATA['http_domain'] ?>public/js.panel/links.js"></script>
</foot>
